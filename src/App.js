...
// Importa parseISO e isValid para manipulação precisa de datas
import { eachHourOfInterval, addHours, format, isValid, parseISO } from 'date-fns'; 
...
export default function PlantaoApp() {
  ...
  const calcularValorFixo = () => {
    ...
    // Usando parseISO para garantir que as datas sejam interpretadas corretamente
    const dataInicio = parseISO(startDateTimeString);
    const dataFim = parseISO(endDateTimeString);
